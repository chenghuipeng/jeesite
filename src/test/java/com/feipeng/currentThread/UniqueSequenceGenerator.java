...
public class UniqueSequenceGenerator {
    ...
    public static void main(String[] args) {
        ...
        // 为每个线程生成内部唯一的序列号
        TaskThread<UniqueSequenceGenerator> t1 = new TaskThread<UniqueSequenceGenerator>(
            "custom-thread-1", uniqueThreadId);
        TaskThread<UniqueSequenceGenerator> t2 = new TaskThread<UniqueSequenceGenerator>(
            "custom-thread-2", uniqueThreadId);
        TaskThread<UniqueSequenceGenerator> t3 = new TaskThread<UniqueSequenceGenerator>(
