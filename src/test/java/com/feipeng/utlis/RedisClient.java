 ...
 * @Author: 飞蓬
 * @Description:
 * @Date:Create：in 2019/4/17 下午4:30
 */
public class RedisClient {
    ...
    private void StringOperate() {
        ...
        jedis.set("key002", "value00211111");
        jedis.set("key002", "value00222222222");
         ...
         */
        System.out.println("一次性新增key201,key202,key203,key204及其对应值：" + jedis.mset("key201",
            "value201", "key202", "value202", "key203", "value203", "key204", "value204"));
    ...
    private void ListOperate() {
        ...
        shardedJedis.setnx("11111111", "22222222222");
        System.out.println("=============增=============");
    ...
    private void SetOperate() {
        ...
        System.out.println("向sets集合中加入元素element001：" + jedis.sadd("sets", "element002"));
        System.out.println("向sets集合中加入元素element001：" + jedis.sadd("sets", "element003"));
        System.out.println("向sets集合中加入元素element001：" + jedis.sadd("sets", "element004"));
        System.out.println("向sets集合中加入元素element001：" + jedis.sadd("sets", "element004"));
    ...
    private void HashOperate() {
        ...
        System.out.println(
            "hashs中的所有值：" + shardedJedis.hvals("hashs") + shardedJedis.hget("hashs", "key004"));
        System.out.println();
    ...
    public boolean lock2(String key, int expire) {
        ...
        long oldExpireTime = Long.parseLong(jedis.get(key) == null ? "0" : jedis.get(key));
        if (oldExpireTime < System.currentTimeMillis()) { //超时            
            long newExpireTime = System.currentTimeMillis() + expire;
            long currentExpireTime = Long
                .parseLong(jedis.getSet(key, String.valueOf(newExpireTime)));
    ...
    public void drawRedPacket() {
        RedisClient redisClient = new RedisClient();
        String key = "draw.redpacket.userid:" + 111;
        boolean lock = lock(key, 60);
        if (lock) {
            try {
